...
@@ -52,7 +24,7 @@ function recordEngineState() {
}
...
function undoEngineAction() {
  if (historyIndex > 0) {
@@ -65,7 +37,7 @@ function undoEngineAction() {
}
...
function redoEngineAction() {
  if (historyIndex < sceneHistory.length - 1) {
@@ -77,801 +49,30 @@ function redoEngineAction() {
  }
}
...
@@ -886,17 +87,13 @@ function deleteActiveVortexScript() {
    return;
  }
...
@@ -907,7 +104,10 @@ function deleteActiveVortexScript() {
  }
}
...
function renderScriptsSidebarList() {
  ...
  if (!list) return;
@@ -925,456 +125,94 @@ function renderScriptsSidebarList() {
  });
}
